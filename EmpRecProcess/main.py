...
my_database = my_client["employee_recruitment"]
admin_collection = my_database["admin"]
companies_collection = my_database["companies"]
recruiter_collection = my_database["recruiter"]
seeker_collection = my_database["seeker"]
skill_collection = my_database["skill_collection"]
job_post_collection = my_database["job_post"]
job_application_collection = my_database["job_application"]
interview_collection = my_database["interview"]
